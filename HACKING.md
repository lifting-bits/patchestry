...
hidden if the `patchestry_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `patchestry_DEVELOPER_MODE` to the configure
...
Runs the executable target `patchestry_exe`.
