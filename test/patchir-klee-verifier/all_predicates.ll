...
; CHECK-LABEL: define i32 @bl_device__process_entry(ptr %dest, i32 %dest_size, ptr %format)
; Precondition 1 — nonnull on Arg(0)
; CHECK:       icmp ne ptr
...
; CHECK:       icmp eq
; CHECK:       call void @klee_assume(
; Precondition 3 — relation neq on Arg(1)
; CHECK:       icmp ne i32
; CHECK:       call void @klee_assume(
; The contracted call
; CHECK:       call i32 @snprintf(
; Postcondition — range on ReturnValue [0, 32]; layout
