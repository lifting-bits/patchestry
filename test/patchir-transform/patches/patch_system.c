...
extern unsigned int system(const unsigned char *command);
...
// Note: unsigned char* param and unsigned return match CIR types from decompiled binary.
unsigned int patch__replace__system(const unsigned char *command, uint32_t max_len) {
