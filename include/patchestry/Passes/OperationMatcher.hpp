...
namespace patchestry::passes {
    ...
    class OperationMatcher
    {
      public:
         ...
         */
        static bool
        contract_action_matches(mlir::Operation *op, cir::FuncOp func, const contract::ContractAction &spec, Mode mode);
         ...
         */
        static bool
        patch_action_matches(mlir::Operation *op, cir::FuncOp func, const patch::PatchAction &spec, Mode mode);
