...
namespace patchestry::ast {
    ...
    /// How to re-enter a C translation unit written by `-print-tu`, or
    /// refined from it.
    ...
    /// target fallback and the marker-to-function map for `-print-tu`.  Null
    /// (after logging) when the file cannot be read, no target can be
    /// resolved, the frontend fails to set up, or parsing reports errors.
